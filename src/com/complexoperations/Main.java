/*
    A complex number is a number that can be expressed in the form a + bi, where a and b are real numbers, and i is
        a solution of the equation x2 = −1. Because no real number satisfies this equation, i is called an imaginary
    ...
    * Method named add with one parameter other of type ComplexNumber. It needs to add the other parameter to this
        complex number.
